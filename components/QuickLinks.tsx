  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-full">
      ...
      >
        ...
        <span className="text-xs font-bold text-emerald-700 dark:text-emerald-100/70 tracking-wide">Email Me</span>
      </a>
      ...
      >
        ...
        <span className="text-xs font-bold text-emerald-700 dark:text-emerald-100/70 tracking-wide">Resume</span>
      </a>
      ...
      >
        ...
        <span className="text-xs font-bold text-emerald-700 dark:text-emerald-100/70 tracking-wide">GitHub</span>
      </a>
      ...
      >
        ...
        <div className="text-center">
          <span className="block text-xs font-bold text-emerald-700 dark:text-emerald-100/70 tracking-wide">SMU IS</span>
          <span className="text-[10px] text-emerald-600 dark:text-emerald-500/50 font-mono uppercase mt-1">AI Major</span>
        </div>
      </div>
    </div>
  );
